...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Element.recommended'
        db.add_column('element', 'recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.recommended'
        db.add_column('group', 'recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Element.recommended'
        db.delete_column('element', 'recommended')

        # Adding unique constraint on 'Element', fields ['name', 'group']
        db.create_unique('element', ['name', 'group_id'])

        # Deleting field 'Group.recommended'
        db.delete_column('group', 'recommended')
    ...
    models = {
        ...
        u'dialog.element': {
            ...
            'Meta': {'object_name': 'Element', 'db_table': "'element'"},
