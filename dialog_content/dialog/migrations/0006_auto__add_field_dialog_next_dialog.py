...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dialog.next_dialog'
        db.add_column('dialog', 'next_dialog',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dialog.Dialog'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dialog.next_dialog'
        db.delete_column('dialog', 'next_dialog_id')
